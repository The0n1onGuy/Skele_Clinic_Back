...
create table system_users (id_user bigint AUTO_INCREMENT not null, role_id bigint not null, status_id bigint not null, uuid varchar(36) not null, tenant_id varchar(50) default 'his_rpbi_master' not null, password varchar(255) not null, user_name varchar(255) not null, primary key (id_user));
...
-- DICCIONARIO GLOBAL DE ESTATUS (his_rpbi_master)
