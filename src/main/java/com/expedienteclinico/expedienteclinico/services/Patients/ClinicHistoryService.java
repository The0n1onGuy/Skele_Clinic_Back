...
public class ClinicHistoryService {
    ...
    public List<ClinicHistoryBean> getAllClinicHistory() {
        ...
        for (ClinicHistoryModel entidad : entidades) {
            ...
            dto.setEnfermedadActual(entidad.getEnfermedadActual());
    ...
    public Object nuevo(ClinicHistoryBean bean) {
        ...
        entidad.setEnfermedadActual(bean.getEnfermedadActual());
    ...
    public ResponseEntity<?> updateData(@Valid ClinicHistoryModel bean, BindingResult result, Long id) {
        ...
        try {
            ...
            historialActual.setEnfermedadActual(bean.getEnfermedadActual());
            historialActual.setDiagnosticoPreliminar(bean.getDiagnosticoPreliminar());

            if (bean.getPacienteId() != null && !bean.getPacienteId().equals(historialActual.getPaciente().getId())) {
